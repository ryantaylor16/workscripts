...
echo "Starting FastClearLogFileAlerts.ps1" | out-File c:\SCOMManagementScripts\testout.txt -append
...
$reftime = $timenowutc.addminutes(-1)
...
get-Alert | where {$_.customfield2 -eq "FAST_CLEAR" -and $_.ResolutionState -ne 255 -and $_.TimeRaised -lt $reftime } | resolve-alert

#write-host "All IPNlogfile alerts originating before " $reftime " have been removed"