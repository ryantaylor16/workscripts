...
# AUTHOR:	Tao Yang 
# DATE:		05/08/2012
# Name:		Push-OM12SkypeNotification.PS1
# Version:	1.0
# COMMENT:	Remotely Execute Send-SkypeNotification.PS1 using PsExec.exe
# Usage:	.\Push-OM12SkypeNotification.PS1 -SkypeNode "SkypeNodeComputer" -SendScriptPath "C:\Scripts\Send-OM12SkypeNotification.PS1" -alertID xxxxx -Recipients "SkypeID#1;#SkypeID#2"
#==========================================================================================================================
...
$strPushCmd = "$PsExecPath /accepteula -s \\$SkypeNode -i $SkypeProcessSessionID $PSPath $SendScriptPath -SCOMMgtServer $env:computername -AlertID $AlertID -Recipients `'$Recipients`'"
